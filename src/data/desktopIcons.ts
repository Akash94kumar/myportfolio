...
export const desktopIcons: DesktopIcon[] = [
  { id: 'about', name: 'About Me', icon: 'FaUserTie', component: 'AboutMe', order: 1 },
  { id: 'resume', name: 'Resume', icon: 'FaFileAlt', component: 'Resume', order: 2 },
  { id: 'skills', name: 'Skills', icon: 'FaTools', component: 'Skills', order: 3 },
  { id: 'experience', name: 'Experience', icon: 'FaTimeline', component: 'Experience', order: 4 },
  { id: 'projects', name: 'Projects', icon: 'FaFolderOpen', component: 'Projects', order: 5 },
  { id: 'contact', name: 'Contact', icon: 'FaEnvelope', component: 'Contact', order: 6 },
];
